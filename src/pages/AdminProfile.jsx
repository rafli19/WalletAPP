...
const AdminProfile = ({ user, onLogout, onUserUpdated }) => {
  ...
  return (
    <AdminLayout user={user} onLogout={onLogout}>
      ...
      <div className="page-header">
        ...
        <p className="page-sub">Kelola informasi akun Admin</p>
      </div>
      ...
      <div className="panel panel-sm">
        ...
        <div className="form-field text-center mb-6">
          ...
          {errors.avatar && <div className="form-err">{errors.avatar}</div>}
